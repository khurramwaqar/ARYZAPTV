...
fun DashboardScreen(
    ...
    openSeriesDetailScreen: (seriesId: String) -> Unit,
    openVideoPlayer: (videoPath: String) -> Unit,
    ...
    BackPressHandledArea(
        ...
        Body(
            ...
            openSeriesDetailsScreen = openSeriesDetailScreen,
...
private fun Body(
    openCategoryMovieList: (categoryId: String) -> Unit,
    openMovieDetailsScreen: (movieId: String) -> Unit,
    openSeriesDetailsScreen: (seriesId: String) -> Unit,
    openVideoPlayer: (videoPath: String) -> Unit,
    ...
    NavHost(
        ...
        composable(Screens.Home()) {
            ZHomeScreen(
                onSeriesClick = {series -> openSeriesDetailsScreen(series.id)},
