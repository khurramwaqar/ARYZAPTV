...
fun SeriesScreenMovieList(
    ...
    AnimatedContent(
        ...
        TvLazyRow(
            ...
            movieListTarget.forEach { series ->
                item {
                    SeriesListItem(
                        itemWidth = itemWidth,
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        CompactCard(
            ...
            image = {
                ...
                AsyncImage(
                    model = "https://node.aryzap.com/public/"+series.imageCoverDesktop,
                    contentDescription = StringConstants
                        .Composable
                        .ContentDescription
                        .moviePoster(series.title),
